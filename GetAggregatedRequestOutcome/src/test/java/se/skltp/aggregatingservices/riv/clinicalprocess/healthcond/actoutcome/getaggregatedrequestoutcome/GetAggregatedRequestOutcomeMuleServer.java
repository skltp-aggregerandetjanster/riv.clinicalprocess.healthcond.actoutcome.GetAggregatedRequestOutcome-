...
public class GetAggregatedRequestOutcomeMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedRequestOutcome";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedRequestOutcomeMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedRequestOutcome-common.xml"
        //
