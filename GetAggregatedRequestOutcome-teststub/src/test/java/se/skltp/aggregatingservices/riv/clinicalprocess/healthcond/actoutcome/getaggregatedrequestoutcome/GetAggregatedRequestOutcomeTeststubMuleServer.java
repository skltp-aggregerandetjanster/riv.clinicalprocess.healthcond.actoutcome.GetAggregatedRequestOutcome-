...
public class GetAggregatedRequestOutcomeTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedRequestOutcome-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedRequestOutcomeTeststubMuleServer.class);
